# openclaw-telegram-approval-sidecar Agent README

## Project Reality

- Project: openclaw-telegram-approval-sidecar
- Repository path: /home/vkleo/.openclaw/workspace/development/openclaw-extensions/openclaw-telegram-approval-sidecar
